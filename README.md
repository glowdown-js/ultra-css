...
- [🧩 All Supported Elements](#-all-supported-elements)
...
- 🎯 **Classless** — Works with semantic HTML, no classes needed
- 🪟 **Glassmorphism** — Beautiful glass effects on cards, buttons & inputs
- 🌓 **Dark/Light Mode** — User-managed theme switching via `data-theme`
- 🎨 **2000+ Lines** — Comprehensive styling for ALL HTML elements
